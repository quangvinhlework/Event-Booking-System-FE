  ...
  return (
    ...
    >
      <div className="luxury-card__media">
        ...
        {categoryName && <span className="luxury-card__tag">{categoryName}</span>}
      </div>

      <div className="luxury-card__body">
        <h3 className="luxury-card__title">{event.name || event.title}</h3>
        <p className="luxury-card__desc">{event.description}</p>

        <ul className="luxury-card__meta">
          <li>
        ...
        <div className="luxury-card__availability">
          <span>
            Vé còn <strong>{availableTickets}</strong> / {totalTickets}
          </span>
          <div className="luxury-card__bar">
            <div className="luxury-card__bar-fill" style={{ width: `${ticketPercent}%` }} />
          </div>
        </div>

        <div className="luxury-card__footer">
          <div className="luxury-card__price">
            <small>Từ</small>
            <span>{price} đ</span>
          </div>
          <span className="luxury-card__cta" aria-hidden="true">
            Chi tiết
