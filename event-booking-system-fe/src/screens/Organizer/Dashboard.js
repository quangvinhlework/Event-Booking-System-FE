...
const Dashboard = () => {
  ...
  }, [periodType, month, quarter, year, fetchEventStatisticsByMonth, fetchEventStatisticsByQuarter, fetchEventStatisticsByYear]);
  ...
  return (
    ...
    >
      <LoadingOverlay loading={overviewLoading || performanceLoading} text="Đang tải dữ liệu..." />
